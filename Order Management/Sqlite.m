...
- (NSInteger)rowId {
    NSLog( @"Insert into row id = %lld", sqlite3_last_insert_rowid(_db));
...
//        text = NULL;
//        return str;
//        __weak NSString  * str = [[NSString alloc]initWithUTF8String:(char *)sqlite3_column_text(stmt, index)];
//        NSString * temp = str;
//        NSString  *str = [[NSString alloc]initWithFormat:@"%s",sqlite3_column_text(stmt, index)];
//        NSString * __weak string = [[NSString alloc] initWithFormat:@"First Name: %@", [self firstName]];
        return [NSString stringWithUTF8String:(char *)sqlite3_column_text(stmt, index)]; //CHANGE HERE FOR ENCOING ARABIC (OTHER LANGUAGE) DATA

        //old working code
//        return [NSString stringWithFormat:@"%s",sqlite3_column_text(stmt, index)];
        //return string;
//        return temp;
//        return (NSString *)CFBridgingRelease((char *)sqlite3_column_text(stmt, index));
//        return
//        return str;
//        return [NSString stringWithUTF8String:(char *)text];
//		return [NSString stringWithFormat:@"%@", [[NSString alloc] initWithUTF8String:(char *)text] ];
	}
